        ...
        <CardContent className="h-full overflow-hidden border-none mt-4 relative">
          <ScrollArea className="w-full h-full" ref={scrollAreaRef}> {/* 👈 Set the ref */}
            <div className="space-y-2">
              ...
              {isCleanDataLoading && <div className="p-2 rounded-lg flex justify-center items-center gap-1 text-sm mr-auto text-secondary-foreground w-full mt-2"><SmallLoading /></div>}
