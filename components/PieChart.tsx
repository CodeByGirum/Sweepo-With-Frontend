...
/**
 * Monochrome color mapping for different issue types
 */
const COLORS = {
  INVALID_VALUE: "#FFFFFF",
  TYPE_MISMATCH: "#E0E0E0",
  NULL_VALUE: "#C0C0C0",
  DUPLICATE_VALUE: "#A0A0A0",
  INVALID_FORMAT: "#808080",
  INVALID_SEPARATOR: "#606060",
  INVALID_DATE: "#404040"
}
