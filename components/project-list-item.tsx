 ...
 * Purpose: Displays project information in a list format
 * Used in: Project list views, search results
 * Features:
...
/**
 * Project list item component for displaying project information in a list format
      ...
      <div className="p-3 flex items-center">
        <div className="flex-1">
          ...
          <div className="flex items-center justify-between">
            <p className="text-gray-400 text-[10px] mt-1">{project.description}</p>
            {project.date && (
              <div className="flex items-center text-[9px] text-gray-400 ml-2">
        ...
        <div className="w-32 px-2">
          <div className="flex justify-between items-center mb-1">
            ...
            <span className="text-[10px] text-white">{project.progress}%</span>
          </div>
        ...
        <div className="flex items-center gap-2 ml-4">
          ...
          <Link
            href={`/cleandata/${project.id}`}
            className="bg-[#2a2a2a] hover:bg-[#3a3a3a] rounded-md py-1 px-2 text-[10px] transition-colors"
          >
            View
          </Link>
