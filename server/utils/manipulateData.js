...
export const manipulateData = (parsedData, actions, issues,schema) => {
    ...
    actions.forEach(action => {
        ...
        switch (action.type) {
            ...
            case "DELETE_ROWS_WITH_NULLS":
                modifiedData = deleteRowsWithNulls(modifiedData, action)
                break;
